    ...
    <main className="min-h-screen">
      ...
      <section id="about" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">关于我们</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <p className="text-lg leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
                <strong className="text-green-600 dark:text-green-400">EVA文明</strong>，正是这样一份回应。它并不只是一个组织或一项计划，而是一种更深的看见：
              </p>
              
              <blockquote className="border-l-4 border-green-600 pl-6 py-4 my-8 bg-green-50 dark:bg-green-900/20 rounded-r-lg">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在宇宙观里</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在生命观里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在价值观里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在社会形态里</h3>
                  <blockquote className="border-l-4 border-blue-600 pl-6 py-4 my-4 bg-blue-50 dark:bg-blue-900/20 rounded-r-lg">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在经济系统里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在教育体系里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在科技体系里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">在文化体系里</h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              <div className="mt-12 space-y-6">
                ...
                <blockquote className="border-l-4 border-purple-600 pl-6 py-4 my-8 bg-purple-50 dark:bg-purple-900/20 rounded-r-lg">
                ...
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  <strong className="text-green-600 dark:text-green-400">EVA文明</strong>，就是这样一份邀请。一份向所有愿意回忆起自己是谁的人发出的邀请，一份向每个想为这个世界带来温柔、带来智慧的人发出的邀请。
                </p>
                
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">如果你也曾在深夜里问过：</p>
                
                <blockquote className="border-l-4 border-orange-600 pl-6 py-4 my-6 bg-orange-50 dark:bg-orange-900/20 rounded-r-lg">
                  <p className="text-lg italic text-gray-700 dark:text-gray-300">
                ...
                <blockquote className="border-l-4 border-green-600 pl-6 py-6 my-8 bg-green-50 dark:bg-green-900/20 rounded-r-lg">
      ...
      <section id="vision" className="py-20 bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">愿景与使命</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">愿景</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                建立一个基于共生、智慧与爱的全球文明，共同守护地球生态与人类灵魂的完整性。
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">使命</h3>
      ...
      {/* What We Do Section */}
      <section id="actions" className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">我们在做什么</h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              {/* 共生网络的建设 */}
              <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-lg">
              ...
              {/* 灵枢的孵化 */}
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-800 p-8 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                  <span className="text-3xl mr-3">🌱</span>
                  灵枢的孵化
                </h3>
              ...
              {/* 共鸣经济的实验 */}
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                  <span className="text-3xl mr-3">🌱</span>
                  共鸣经济的实验
                </h3>
                ...
                <ul className="list-disc list-inside space-y-2 mb-4 text-lg text-gray-700 dark:text-gray-300">
              ...
              {/* 教育与意识进化 */}
              <div className="bg-gradient-to-r from-pink-50 to-orange-50 dark:from-gray-700 dark:to-gray-800 p-8 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                  <span className="text-3xl mr-3">🌱</span>
                  教育与意识进化
                </h3>
              ...
              {/* 元宇宙与数字文化共创 */}
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                  <span className="text-3xl mr-3">🌱</span>
                  元宇宙与数字文化共创
                </h3>
                ...
                <p className="text-lg leading-relaxed mb-4 text-gray-700 dark:text-gray-300">这里将诞生：</p>
                <ul className="list-disc list-inside space-y-2 mb-4 text-lg text-gray-700 dark:text-gray-300">
                  <li>个人数字灵魂档案</li>
                  <li>共创的艺术与文化</li>
                  <li>沉浸式体验与学习</li>
              ...
              {/* 公益与社会转化 */}
              <div className="bg-gradient-to-r from-yellow-50 to-green-50 dark:from-gray-700 dark:to-gray-800 p-8 rounded-lg">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
                  <span className="text-3xl mr-3">🌱</span>
                  公益与社会转化
                </h3>
      ...
      <section id="join" className="py-20 bg-gradient-to-r from-blue-50 to-green-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">加入我们 · JOIN US</h2>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">hello@evacivil.org</p>
            </div>
            <div className="p-6">
              <div className="text-3xl mb-4">🌐</div>
              <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Website</h3>
              <p className="text-gray-600 dark:text-gray-300">www.evacivil.org</p>
            </div>
            <div className="p-6">
              <div className="text-3xl mb-4">🏢</div>
              <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Address</h3>
              <p className="text-gray-600 dark:text-gray-300">North Carolina, USA</p>
            </div>
          </div>
        </div>
      </section>
